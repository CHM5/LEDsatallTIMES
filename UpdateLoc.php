 ...
 */
    ...
    $user = $_POST["user"];
    $location_act = $_POST["location_act"];
    $stock_id = $_POST["stock_id"];

    // Ejecuta la actualizacion del registro    
    $statement = mysqli_prepare($con, "UPDATE stock SET location = ? WHERE stock_id = ? ");
    mysqli_stmt_bind_param($statement, "ss", $location_act, $stock_id);
    ...
    $qty_prev = $_POST["qty"];
    $qty_act = "No changes";
    $location_prev = $_POST["location_prev"];
    $location_act = $_POST["location_act"];
